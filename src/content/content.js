...
const processImages = () => {
  ...
  // Only store images if we have any that passed the size filter
  if (processedImages.length > 0) {
    // Store the processed images in chrome.storage instead of sending to popup
    ...
    console.log('No images found above 1000 bytes threshold in this batch');
    isProcessing = false;
  }
};
